...
plugin_url = "https://github.com/harisjmd/OctoPrint-TapoSmartplug"
...
try:
	...
	print(
			"Could not import OctoPrint's setuptools, are you sure you are running that under the same python "
			"installation that OctoPrint is installed under?"
	)
	import sys
